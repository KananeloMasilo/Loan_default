...
def predict():
    if request.method ==  'POST':
        ...
        prediction = model_predict.predict([[gender, married, dependents, education, self_employed, credit, area, ApplicantIncomelog,LoanAmountlog, Loan_Amount_Term_Log, totalincomelog]])
